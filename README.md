...
1. Форкнуть репозиторий, который планируем дополнить (улучшить).
2. Клонировать форкнутый репозиторий к себе в локальную деректорию.
3. Создать новую ветку для внесения изменений.
4. Внести необходимые изменения.
5. Выполнить git add и git commit.
6. Выполнить программу push для обновления информации на github.
7. Выполнить пул реквест путем нажатия кнопки.