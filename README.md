...
Для описания проектов на GitHub используется README.md, который пишется на языке разметки markdown. Что и как поддерживается - расписано ниже. Очень полезно, рекомендуется к прочтению!!!
