...
* git clone (ссылка на репозиторий) - добовляет репозиторий с github в вашу локальную папку.
* cd (имя директории) - смена директроии в локальной папке.
* git push - отправка текущих изменений локального файла на gihub
* git pull - загрузка акутальной версии репозитория с github в ваш локальный дипозиторий.