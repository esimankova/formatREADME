...
# Работа с Git. Удалённые репозитории
...
`git remote add origin https://github.com/esimankova/formatREADME.git` # добавить удалённый репозиторий (с сокр. именем origin) с указанным URL
