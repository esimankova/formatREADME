# Выполнение ДЗ по Семинару 3

Нужно себе скопировать файл от преподавателя, добавить несколько строк, и отправить обратно с предложением внесенных изменений Pull Request
