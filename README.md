...
При использовании нижнего подчеркивания
```
____
```
...
# Заголовок 1
```
Заголовок первого уровня также можно создать с помощью двойного ряда тире:
```
Заголовок 1
===========
```
...
## Заголовок 2
```
Заголовок второго уровня также можно создать с помощью одинарного ряда тире:
```
Заголовок 2
-----------
```
...
```
~~Зачеркнутый текст~~ создаем с помощи двойной Тильды с двух сторон текста
```
~~Зачеркнутый текст (Strikethrough)~~

Для выделения текста **`жирным`** или *`наклонным`* и их сочетания можно использовать комбинации `*` или `_` с двух сторон текста:
