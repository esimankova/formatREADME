...
# Дополнительная информация по работе с Git. Как работать с удалённым репозиторием.

Давайте вообразим что тут много информации по теме "Работа с удалёнными репозиториями."