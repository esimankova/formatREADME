...
### Первое знакомтсво с Git Hub.com, инструкция:
1. Создать аккаунт на Git Hub.com 
2. Создать локальный репозиторий
3. "Подружить" ваш локальный репозиторий с удаленным репозиторием (з команды)
4. Отправить (push) ваш локальный репозиторий в удаленный (на Git Hub), авторизоваться на удаленном репозитории.
