...
Всего существует шесть уровней заголовков. Для того, чтобы создать заголовок, необходимо в начале строки добавить символы `#`, в количестве равном его уровню или указать `<h1> - <h6>`, где `<h1>` - Наибольший уровень заголовка, а `<h6>` - наименьший
____
