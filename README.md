...
13. [Работа с удаленными репозиториями](#работа-с-удаленными-репозиториями)
...
Для привязки локального репозитория к удаленному, нам нужно:
1. Создать профиль на сайте [github.com](https://github.com/)
2. В левом верхем углу страницы нажать на кнопку +
3. В открывшемся окне ввести название репозитория
4. Там, где будет надпись "…or push an existing repository from the command line", нужно скопировать содержимое и вставить в терминал Вашего редактора кода
5. "Подружить гит и редактор"

Все! Мы создали и привязали наш удаленный репозиторий к локальному
