...
# Заголовок 1
```
Заголовок первого уровня также можно создать с помошью двойного тире:
```
Заголовок 1
===========
```
...
## Заголовок 2
```
Заголовок второго уровня также можно создать с помощью одинарного тире:
```
Заголовок 2
-----------
```
...
```
~~Зачеркнутый текст~~ создается с помощью двойной тильды с двух сторон текста
```
