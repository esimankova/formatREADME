...
3. На сайте нажмите на "Добавить репозиторий" и, следуя инструкции, подружите Ваш локальный репозиторий с GitHub
4. С помощью команды *push* отправьте Ваш локальный репозиторий в удалённый
5. Тут можно изменять Ваш репозиторий онлайн или с другого компьютера
6. С помощью команды *pull* выкачайте актуальное состояние из удаленного репозитория 
7. Поздравляю, Вы молодцы!
