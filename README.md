...
# Заголовок 1
```
Заголовок первого уровня также можно создать с помощью двойного подчеркивания:
```
Заголовок 1
===========
```
...
## Заголовок 2
```
Заголовок второго уровня также можно создать с помощью одинарного подчеркивания:
```
Заголовок 2
-----------
```
...
```
~~Зачеркнутый текст~~ получается за счет двойной Тильды с двух сторон текста
```
