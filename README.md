...
Для начала работы, выберите необходимый репозиторий в GitHub и сохраните ссылку на него. Далее команда git clone (ссылка) позволяет скопировать и внести удалённый репозиторий в локальную папку
