# Установка Visual Studio code и Git в Windows

1. Зайдите на страницу *https://code.visualstudio.com/download* и скачайте установочный файл программы Visual Studio Code для Windows, в зависимости от типа системы (64 или 32 разрядные системы). Запустите установочный файл VSCodeUserSetup-x64-1.71.2.

![картинка 1](pic1.jpg)

2. Для установки Git в Windows достаточно зайти на страницу *http://git-scm.com/download/win*, и загрузка начнется автоматически. Дополнительная информация находится на `сайте` *http://msysgit.github.io/*.
