...
## Домашнее задание к уроку №3 "Введение в контроль версий"

**Инструкция для выполнения pull request:**

1. Делаем копию понравившегося удалённого репозитория к себе в аккаунт на github с помощью fork.
2. Создаём папку на своём компьютере в которую будет клонирован удалённый репозиторий.
3. Открываем её в VSc.
4. Запускаем терминал: Вид -> Терминал
5. В терминале прописываем команду git clone ссылка на форкнутый репозиторий в своём аккаунте на github
6. Добавляем отслеживание ГИТом новой папки командой: cd название папки.
7. Создаём ветку с предлагаемыми изменениями. Важно!!! Производим все изменения только в этой ветке.
8. Фиксируем изменения командами git add b git commit, предварительно сохранив файл.
9. Отправляем эти изменения на свой аккаунт командой git push.
10. В аккаунте на github появится возможность отправить наше предложение pull request.
