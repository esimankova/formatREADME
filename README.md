...
Команды для удаленного взаимодействия с репозиториями:

1. git clone адрес_репозитория (создание локальной копии репозитория)
2. git pull стянуть текущую версию репозитория
3. git push отправить локальные изменения в удаленный репозиторий