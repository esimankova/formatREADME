...
Для описания проектов на GitHub используется README.md, который пишется на языке разметки markdown. Что и как поддерживается - расписано ниже. READ ME с английского переводится как "прочти меня"
