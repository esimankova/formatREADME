...
12. [Инструкция по работе с git](#Инструкция по работе с git)
14. [Ветки в git](#Ветки в git)
15. [Работа с удаленным репозиторием GitHub](#Работа с удаленным репозиторием GitHub)
