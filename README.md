...
- [Описание разметки файла README.md](#описание-разметки-файла-readmemd)
...
- [Заголовок первого уровня](#заголовок-первого-уровня)
  - [Заголовок второго уровня](#заголовок-второго-уровня)
    - [Заголовок третьего уровня](#заголовок-третьего-уровня)
      - [Заголовок четвертого уровня](#заголовок-четвертого-уровня)
        - [Заголовок пятого уровня](#заголовок-пятого-уровня)
          - [Заголовок шестого уровня](#заголовок-шестого-уровня)
  - [Работа с выделением текста](#работа-с-выделением-текста)
  - [Использование эмодзи (emoji)](#использование-эмодзи-emoji)
  - [Использование цитирования в тексте](#использование-цитирования-в-тексте)
  ...
  - [Вставка изображения](#вставка-изображения)
    - [Дополнительно:](#дополнительно)
      - [Вставка ссылки с картинкой на ролик с YouTube](#вставка-ссылки-с-картинкой-на-ролик-с-youtube)
  - [Вставка таблиц](#вставка-таблиц)
  - [Диаграмм Mermaid.js](#диаграмм-mermaidjs)
...
Чтобы создать репозиторий в новой папке, необходимо в терминале прописать команду "git init"

Чтобы проверить состояние кода, нужно прописать команду "git status"

Чтобы создать ветку, нужно прописать "git branch имя новой ветки"

Чтобы переключиться между ветками, нужно прописать "git checkout название ветки"