...
Github является самым популярным сервисом, позволяющим работать с удаленным репозитарием.

Основные команды для работы с удаленным репозиторием:
* git clone *repository adress on github.com* - позволяет склонировать внешний репозиторий на свой ПК
* git pull - позволяет скачать все из текущего репозитория и автоматически сделать merge с нашей версией
* git push - позволяет отправить нашу текущую версию репозитория на внешний репозиторий. При это требуется авторизация на внешнем репозитории.

Как сделать pull request:
1. Делаем fork репозитория;
2. Делаем clone своей версии репозитория на своем ПК;
3. Создаем новую ветку и вносим в нее свои изменения;
4. Фиксируем измнения (git commit);
