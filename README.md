...
13. [Работа с удаленным репозиторием](#Удаленный_Репозиторий)
...
#### Вставка кода из JavaScript

```js

let count = 0, timeTotal = 0;
let distance = 10000;
let vHuman1 = 1, vHuman2 = 2, vDog = 5;
let tFinal = distance / (vHuman2 - vHuman1) - 10;
...
Для начала создайте аккаунт на [GitHub](https://github.com/)